...
{
	uint16_t crc = CRC_INIT;
	buildCRC(crc, pPacket->byPacketSize);
	buildCRC(crc, pPacket->byPacketVersion);
	buildCRC(crc, pPacket->byPacketID);
	buildCRC(crc, pPacket->byDeviceID);
	buildCRC(crc, pPacket->byPacketDataX);
	buildCRC(crc, pPacket->byPacketDataY);
	buildCRC(crc, pPacket->byPacketDataZ);
	buildCRC(crc, 0);
	buildCRC(crc, 0);
